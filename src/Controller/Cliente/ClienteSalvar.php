...
class ClienteSalvar implements InterfaceControlaRotas
{
  public function ProcessaRequisicao(): void
  {
    ...
    try {
      $cliente = new Cliente(null, $idTipoPessoa, "", $cpf_cnpj, $nome, new \DateTimeImmutable($dtNascimento));
      ...
      $endereco01 = new Enderecos(null, $tipoEndereco[0], $cep[0], "", $descricao[0], $bairro[0], $cidade[0], $estado[0], $numero[0], $cliente->getId(), true);
      $endereco02 = new Enderecos(null, $tipoEndereco[1], $cep[1], "", $descricao[1], $bairro[1], $cidade[1], $estado[1], $numero[1], $cliente->getId(), false);
